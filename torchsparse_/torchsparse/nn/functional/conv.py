...
import torchsparse_.torchsparse.backend
from torchsparse_.torchsparse import SparseTensor
from torchsparse_.torchsparse.nn import functional as F
...
def conv3d(
    ...
    conv_mode_num = 0
    global buffer
    if torchsparse_.torchsparse.backends.benchmark:  # type: ignore
