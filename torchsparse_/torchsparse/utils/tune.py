...
from torchsparse_ import torchsparse
from torchsparse_.torchsparse import SparseTensor
from torchsparse_.torchsparse.nn import Conv3d
from torchsparse_.torchsparse.utils import make_ntuple
...
def tune(
    ...
    if not torchsparse_.torchsparse.backends.benchmark:  # type: ignore
        print(
            'Warning: to use tuning, '
            + 'torchsparse.backends.benchmark is automatically set to be true.')
        torchsparse_.torchsparse.backends.benchmark = True  # type: ignore
